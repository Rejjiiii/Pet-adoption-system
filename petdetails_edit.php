                                    ...
                                    <div class="p-5">
                                        ...
                                        <form method="post" class="user" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <button type="submit" name="click" value="update details" class="w-100 btn btn-success btn-user btn-block mt-3" style="height: 3rem;">Update Pet Details</button>
                                            </div>
                                            <div class="form-group">
                                                <a class="w-100 btn btn-danger btn-user btn-block mt-3" style="height: 3rem;" href="admin_adoption.php">Cancel</a>
                                            </div>
                                        </form>
                                    </div>                                    
                                </div>
...
if (isset($_POST['click'])) {
    ...
    $query = $con->prepare("update petdetails set pet_name='$petname',pet_age='$petage',pet_color='$petcolor',vaccinated='$vaccinated',breed='$breed',description='$description' where pet_id='$petid'");
